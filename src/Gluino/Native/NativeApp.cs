...
internal partial class NativeApp
{
    ...
    public static partial nint Create(nint hInstance);

    [LibImport("Gluino_App_Destroy")]
    public static partial void Destroy(nint app);

    [LibImport("Gluino_App_SpawnWindow")]
    public static partial nint SpawnWindow(nint app, ref NativeWindowOptions options);

    [LibImport("Gluino_App_DespawnWindow")]
    public static partial void DespawnWindow(nint app, nint window);

    [LibImport("Gluino_App_Register")]
    public static partial void Register(nint app, string className);
